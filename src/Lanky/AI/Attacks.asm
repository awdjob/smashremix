...
// AI.add_attack_behaviour(USPG,   8, 79, 200, 49, 800)
...
AI.add_attack_behaviour(FAIR,   16, 247, 955, -129, 304)
...
// AI.add_attack_behaviour(USPA,   8, -24, 100, 54, 100) // using low range forwards and upwards for him to only use it when really close
