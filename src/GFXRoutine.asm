...
scope GFXRoutine {
    ...
    SHADOW_SMOKE_SUBROUTINE:; CREATE_GFX(-1, 0x7, 0, 0, 0, 0, 0, 0); BEGIN_LOOP(2); OVERLAY(0x7400A464); WAIT(1); OVERLAY(0x300030D2); WAIT(1); END_LOOP(); RETURN()
    SHADOW_1:; BEGIN_LOOP(4); SUBROUTINE(SHADOW_SUBROUTINE); END_LOOP(); BEGIN_LOOP(4); SUBROUTINE(SHADOW_SMOKE_SUBROUTINE); END_LOOP(); END()
    SHADOW_2:; BEGIN_LOOP(8); SUBROUTINE(SHADOW_SUBROUTINE); END_LOOP(); BEGIN_LOOP(8); SUBROUTINE(SHADOW_SMOKE_SUBROUTINE); END_LOOP(); END()
    SHADOW_3:; BEGIN_LOOP(16); SUBROUTINE(SHADOW_SUBROUTINE); END_LOOP(); BEGIN_LOOP(16); SUBROUTINE(SHADOW_SMOKE_SUBROUTINE); END_LOOP(); END()
    SHADOW_4:; BEGIN_LOOP(24); SUBROUTINE(SHADOW_SUBROUTINE); END_LOOP(); BEGIN_LOOP(20); SUBROUTINE(SHADOW_SMOKE_SUBROUTINE); END_LOOP(); END()
    ...
    insert SSONIC_NSP_LOOP, "gfx/routines/SSONIC_NSP_LOOP.bin"; GO_TO(SSONIC_NSP_LOOP) // loops
    SSONIC_NSP_ATTACK:;  OVERLAY(0xFAF8ABD0); OVERLAY_SHIFT(0xFFAF0000, 8); WAIT(8); CLEAR_OVERLAY();  GO_TO(SSONIC_NSP_LOOP)
    ...
    insert ROY_USP, "gfx/routines/ROY_USP.bin"
    ...
    WAIT(0x1A);
    BEGIN_LOOP(10)
    OVERLAY_SHIFT(0xFF420F46, 4); WAIT(4);
    OVERLAY_SHIFT(0xEDC61346, 4); WAIT(4);
    END_LOOP();
    OVERLAY(0xFFF61156); WAIT(3);
    BEGIN_LOOP(8);
    OVERLAY_SHIFT(0xFF420F70, 3); WAIT(3);
    OVERLAY_SHIFT(0xFFF61170, 3); WAIT(3);
    END_LOOP();
    BEGIN_LOOP(8);
    OVERLAY(0xFFFFFF80); WAIT(3);
    OVERLAY(0xFFE00080); WAIT(3);
    END_LOOP();
    END();

    DSAMUS_DSP:; BEGIN_LOOP(16); OVERLAY(0x2BC3FF80); WAIT(2); OVERLAY(0xADE8FFA0); WAIT(2); END_LOOP(); END()

    KOTH_RED:
    OVERLAY(Color.damage_icon.RED & 0xFFFFFF88);
    OVERLAY(Color.damage_icon.RED & 0xFFFFFF22); WAIT(20);
    OVERLAY(Color.damage_icon.RED & 0xFFFFFF88); WAIT(20);
    END();
    KOTH_BLUE:
    OVERLAY(Color.damage_icon.BLUE & 0xFFFFFF88);
    OVERLAY(Color.damage_icon.BLUE & 0xFFFFFF22); WAIT(20);
    OVERLAY(Color.damage_icon.BLUE & 0xFFFFFF88); WAIT(20);
    END();
    KOTH_GREEN:
    OVERLAY(Color.damage_icon.GREEN & 0xFFFFFF88);
    OVERLAY(Color.damage_icon.GREEN & 0xFFFFFF22); WAIT(20);
    OVERLAY(Color.damage_icon.GREEN & 0xFFFFFF88); WAIT(20);
    END();
    KOTH_YELLOW:
    OVERLAY(Color.damage_icon.YELLOW & 0xFFFFFF88);
    OVERLAY(Color.damage_icon.YELLOW & 0xFFFFFF22); WAIT(20);
    OVERLAY(Color.damage_icon.YELLOW & 0xFFFFFF88); WAIT(20);
    END();
    KOTH_GRAY:
    OVERLAY(Color.damage_icon.GRAY & 0xFFFFFF88);
    OVERLAY(Color.damage_icon.GRAY & 0xFFFFFF22); WAIT(20);
    OVERLAY(Color.damage_icon.GRAY & 0xFFFFFF88); WAIT(20);
    END();

    BALL_FIRE_SUBROUTINE:; OVERLAY(0xFFF078AA); WAIT(1); OVERLAY(0xDC6E1E96); WAIT(1); RETURN()
    BALL_SMOKE_SUBROUTINE:; BEGIN_LOOP(2); OVERLAY(0xB4640064); WAIT(1); OVERLAY(0x3C0000D2); WAIT(1); END_LOOP(); RETURN()
    BALL_FIRE:; OVERLAY(0xFFFFFFFF); WAIT(8); OVERLAY_SHIFT(0xFFF078AA, 12); WAIT(16); CLEAR_OVERLAY() // continues into BALL_FIRE_LOOP
    BALL_FIRE_LOOP:; SUBROUTINE(BALL_FIRE_SUBROUTINE); GO_TO(BALL_FIRE_LOOP)
    BALL_SMOKE:; BEGIN_LOOP(15); SUBROUTINE(BALL_SMOKE_SUBROUTINE); END_LOOP(); END()

    STOPWATCH_SLOWED:
    OVERLAY(0x00AAFF96); WAIT(60);
    STOPWATCH_SLOWED_2:
    OVERLAY_SHIFT(0x00AAFF36, 20); WAIT(20);
    OVERLAY(0x00AAFF36); WAIT(20);
    OVERLAY_SHIFT(0x00AAFF96, 15); WAIT(15);
    OVERLAY(0x00AAFF96); WAIT(30);
    GO_TO(STOPWATCH_SLOWED_2);

    STOPWATCH_FASTED:
    OVERLAY(0xFF642096); WAIT(60);
    STOPWATCH_FASTED_2:
    OVERLAY_SHIFT(0xFF642036, 20); WAIT(20);
    OVERLAY(0xFF642036); WAIT(20);
    OVERLAY_SHIFT(0xFF642096, 15); WAIT(15);
    OVERLAY(0xFF642096); WAIT(30);
    GO_TO(STOPWATCH_FASTED_2);
    ...
    add_gfx_routine(SSONIC_NSP_LOOP, SSONIC_NSP_LOOP, 60, OS.TRUE)
    ...
    add_gfx_routine(EBI_GROW, EBI_GROW, 100, OS.TRUE)
    add_gfx_routine(ROY_USP, ROY_USP, 60, OS.TRUE)
    add_gfx_routine(PARRY, PARRY, 60, OS.TRUE)
    add_gfx_routine(ROY_CHARGE, ROY_CHARGE, 60, OS.TRUE)
    add_gfx_routine(DSAMUS_DSP, DSAMUS_DSP, 60, OS.TRUE)
    add_gfx_routine(KOTH_RED, KOTH_RED, 100, OS.FALSE)
    add_gfx_routine(KOTH_BLUE, KOTH_BLUE, 100, OS.FALSE)
    add_gfx_routine(KOTH_GREEN, KOTH_GREEN, 100, OS.FALSE)
    add_gfx_routine(KOTH_YELLOW, KOTH_YELLOW, 100, OS.FALSE)
    add_gfx_routine(BALL_FIRE, BALL_FIRE, 100, OS.FALSE)
    add_gfx_routine(BALL_SMOKE, BALL_SMOKE, 100, OS.FALSE)
    add_gfx_routine(STOPWATCH_SLOWED, STOPWATCH_SLOWED, 120, OS.FALSE)
    add_gfx_routine(STOPWATCH_FASTED, STOPWATCH_FASTED, 120, OS.FALSE)
