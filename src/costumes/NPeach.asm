scope polygon_peach_costumes {
    ...
    Costumes.define_part(7, 1, Costumes.part_type.PALETTE)      // part 0x8_0 - Neck
    ...
    Costumes.define_part(E, 1, Costumes.part_type.PALETTE)      // part 0xE_0 - weapons
    ...
    Costumes.define_part(19, 1, Costumes.part_type.PALETTE)     // part 0x19_0 - Dress

    // Register extra costumes
    Costumes.register_extra_costumes_for_char(Character.id.NPEACH)
