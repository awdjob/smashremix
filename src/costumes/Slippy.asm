scope slippy_costumes {
    ...
    Costumes.define_special_parts_for_part(2, 2)                                // part 0x2_0_0
    Costumes.add_special_part(2, 1, 3, Costumes.part_type.PALETTE)              // part 0x2_1_0 - torso - rocket firing
    Costumes.add_special_part_image(2, 1, 1, Costumes.part_type.PALETTE)        // part 0x2_1_1 - torso - front
    Costumes.add_special_part_image(2, 1, 2, Costumes.part_type.PRIM_COLOR)     // part 0x2_1_2 - torso - back
    ...
    scope costume_0x6 {
        ...
        rocket_palette:; insert "Slippy/cos_6_2.bin"
        ...
        Costumes.set_palette_for_part(0, 2, 0, rocket_palette)
        Costumes.set_palette_for_part(0, 2, 1, palette_3)
        Costumes.set_prim_color_for_part(0, 2, 2, torso_color)
        Costumes.set_palette_for_special_part(0, 2, 1, 0, palette_3)
        Costumes.set_palette_for_special_part(0, 2, 1, 1, rocket_palette)
        Costumes.set_prim_color_for_special_part(0, 2, 1, 2, torso_color)
