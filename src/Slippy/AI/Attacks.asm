...
// AI.add_attack_behaviour(USPG,   15, 157, 531, 253, 2134-1000) // do not use it from the ground
...
AI.add_attack_behaviour(FAIR,   5, -28, 418, 38, 312)
...
AI.add_attack_behaviour(DSPA,   1, -90, 90, 140, 320)
