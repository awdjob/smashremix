...
scope JKirby {
    ...
    Character.add_new_action_params(JKIRBY, DSAMUS_NSP_Charge_Air,      -1,     0x57E,                                  Kirby.DSAMUS_NSP_CHARGE,    0x00000000)
    Character.add_new_action_params(JKIRBY, CRASH_NSP_Ground,           -1,     File.KIRBY_CRASH_NSP_G,                 Kirby.CRASH_NSP,            0)
    Character.add_new_action_params(JKIRBY, CRASH_NSP_Air,              -1,     File.KIRBY_CRASH_NSP_A,                 Kirby.CRASH_NSP,            0)
    Character.add_new_action_params(JKIRBY, CRASH_NSP_Ground_Blocked,   -1,     File.KIRBY_CRASH_NSP_G_BLOCKED,         Kirby.CRASH_NSP_BLOCKED,    0)
    Character.add_new_action_params(JKIRBY, CRASH_NSP_Air_Blocked,      -1,     File.KIRBY_CRASH_NSP_A_BLOCKED,         Kirby.CRASH_NSP_BLOCKED,    0)
    Character.add_new_action_params(JKIRBY, PEACH_NSP_Ground,           -1,     File.KIRBY_PEACH_NSP_G,                 Kirby.PEACH_NSP,            0)
    Character.add_new_action_params(JKIRBY, PEACH_NSP_Air,              -1,     File.KIRBY_PEACH_NSP_A,                 Kirby.PEACH_NSP,            0)
    Character.add_new_action_params(JKIRBY, PEACH_NSP_Recoil,           -1,     File.KIRBY_PEACH_NSP_RECOIL,                 Kirby.PEACH_NSP_RECOIL,     0)
    Character.add_new_action_params(JKIRBY, ROY_NSPG_1,                 -1,     File.KIRBY_MARTH_NSPG_1,                Kirby.ROY_NSP_1,            0)
    Character.add_new_action_params(JKIRBY, ROY_NSPG_2_High,            -1,     File.KIRBY_MARTH_NSPG_2_HI,             Kirby.ROY_NSP_2_HIGH,       0)
    Character.add_new_action_params(JKIRBY, ROY_NSPG_2_Mid,             -1,     File.KIRBY_MARTH_NSPG_2,                Kirby.ROY_NSP_2,            0)
    Character.add_new_action_params(JKIRBY, ROY_NSPG_2_Low,             -1,     File.KIRBY_MARTH_NSPG_2_LO,             Kirby.ROY_NSP_2_LOW,        0)
    Character.add_new_action_params(JKIRBY, ROY_NSPG_3_High,            -1,     File.KIRBY_MARTH_NSPG_3_HI,             Kirby.ROY_NSP_3_HIGH,       0x40000000)
    Character.add_new_action_params(JKIRBY, ROY_NSPG_3_Mid,             -1,     File.KIRBY_MARTH_NSPG_3,                Kirby.ROY_NSP_3,            0x40000000)
    Character.add_new_action_params(JKIRBY, ROY_NSPG_3_Low,             -1,     File.KIRBY_MARTH_NSPG_3_LO,             Kirby.ROY_NSP_3_LOW,        0x40000000)
    Character.add_new_action_params(JKIRBY, ROY_NSPA_1,                 -1,     File.KIRBY_MARTH_NSPA_1,                Kirby.ROY_NSP_1,            0)
    Character.add_new_action_params(JKIRBY, ROY_NSPA_2_High,            -1,     File.KIRBY_MARTH_NSPA_2_HI,             Kirby.ROY_NSP_2_HIGH,       0)
    Character.add_new_action_params(JKIRBY, ROY_NSPA_2_Mid,             -1,     File.KIRBY_MARTH_NSPA_2,                Kirby.ROY_NSP_2,            0)
    Character.add_new_action_params(JKIRBY, ROY_NSPA_2_Low,             -1,     File.KIRBY_MARTH_NSPA_2_LO,             Kirby.ROY_NSP_2_LOW,        0)
    Character.add_new_action_params(JKIRBY, ROY_NSPA_3_High,            -1,     File.KIRBY_MARTH_NSPA_3_HI,             Kirby.ROY_NSP_3_HIGH,       0)
    Character.add_new_action_params(JKIRBY, ROY_NSPA_3_Mid,             -1,     File.KIRBY_MARTH_NSPA_3,                Kirby.ROY_NSP_3,            0)
    Character.add_new_action_params(JKIRBY, ROY_NSPA_3_Low,             -1,     File.KIRBY_MARTH_NSPA_3_LO,             Kirby.ROY_NSP_3_LOW,        0)
    Character.add_new_action_params(JKIRBY, DRL_NSP_Ground,             0xE7,   -1,                                     Kirby.DRM_NSP_GROUND,       1)
    Character.add_new_action_params(JKIRBY, DRL_NSP_Air,                0xE8,   -1,                                     Kirby.DRM_NSP_AIR,          1)
    Character.add_new_action_params(JKIRBY, LANKY_NSP_Ground,           -1,     File.KIRBY_LANKY_NSPG,                  Kirby.LANKY_NSP_GROUND,     0)
    Character.add_new_action_params(JKIRBY, LANKY_NSP_Air,              -1,     File.KIRBY_LANKY_NSPA,                  Kirby.LANKY_NSP_AIR,        0)
    Character.add_new_action_params(JKIRBY,  SSONIC_NSP_Begin,           -1,     File.KIRBY_SSONIC_NSP_BEGIN,            Kirby.SSONIC_NSP_CHARGE,                 0)
    Character.add_new_action_params(JKIRBY,  SSONIC_NSP_Move,            -1,     File.KIRBY_SSONIC_NSP_MOVE,             Kirby.SSONIC_NSP_MOVE,                   0)
    Character.add_new_action_params(JKIRBY,  SSONIC_NSP_Locked_Move,     -1,     File.KIRBY_SSONIC_NSP_MOVE,             Kirby.SSONIC_NSP_MOVE,                   0)
    ...
    Character.add_new_action(JKIRBY, DSAMUS_Charge,              0xEE,   ActionParams.DSAMUS_Charge,             -1,     -1,                             -1,                                 -1,                                 DSamusNSP.kirby_ground_charge_collision_)
    ...
    Character.add_new_action(JKIRBY, SONIC_NSP_Bounce,           -1,     ActionParams.SONIC_NSP_Bounce,          0x12,   0x800D94E8,                     0,                                  0x800D91EC,                         0x800DE978)
    ...
    Character.add_new_action(JKIRBY, DSAMUS_NSP_Charge_Air,      -1,     ActionParams.DSAMUS_NSP_Charge_Air,     0x12,   DSamusNSP.air_charge_kirby_main, DSamusNSP.air_charge_interrupt_,   0x800D91EC,                         DSamusNSP.air_charge_collision_kirby_)
    Character.add_new_action(JKIRBY, CRASH_NSP_Ground,           -1,     ActionParams.CRASH_NSP_Ground,          0x12,   CrashNSP.ground_main_,          0,                                  CrashNSP.ground_physics_,           CrashNSP.ground_collision_)
    Character.add_new_action(JKIRBY, CRASH_NSP_Air,              -1,     ActionParams.CRASH_NSP_Air,             0x12,   CrashNSP.air_main_,             0,                                  CrashNSP.air_physics_,              CrashNSP.air_collision_)
    Character.add_new_action(JKIRBY, CRASH_NSP_Ground_Blocked,   -1,     ActionParams.CRASH_NSP_Ground_Blocked,  0x12,   CrashNSP.blocked_main_,         0,                                  0x800D8BB4,                         CrashNSP.blocked_ground_collision_)
    Character.add_new_action(JKIRBY, CRASH_NSP_Air_Blocked,      -1,     ActionParams.CRASH_NSP_Air_Blocked,     0x12,   CrashNSP.blocked_main_,         0,                                  CrashNSP.blocked_air_physics_,      CrashNSP.blocked_air_collision_)
    Character.add_new_action(JKIRBY, PEACH_NSP_Ground,           -1,     ActionParams.PEACH_NSP_Ground,          0x12,   0x800D94C4,                     0,                                  PeachNSP.ground_physics_,           PeachNSP.ground_collision_)
    Character.add_new_action(JKIRBY, PEACH_NSP_Air,              -1,     ActionParams.PEACH_NSP_Air,             0x12,   0x800D94E8,                     0,                                  PeachNSP.air_physics_,              PeachNSP.air_collision_)
    Character.add_new_action(JKIRBY, PEACH_NSP_Recoil,           -1,     ActionParams.PEACH_NSP_Recoil,          0x12,   0x800D94E8,                     0,                                  0x800D91EC,                         0x800DE99C)
    Character.add_new_action(JKIRBY, ROY_NSPG_1,                 -1,     ActionParams.ROY_NSPG_1,                0x12,   MarthNSP.ground_main_,          0,                                  0x800D8CCC,                         MarthNSP.kirby_ground_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPG_2_High,            -1,     ActionParams.ROY_NSPG_2_High,           0x12,   MarthNSP.ground_main_,          0,                                  0x800D8CCC,                         MarthNSP.kirby_ground_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPG_2_Mid,             -1,     ActionParams.ROY_NSPG_2_Mid,            0x12,   MarthNSP.ground_main_,          0,                                  0x800D8CCC,                         MarthNSP.kirby_ground_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPG_2_Low,             -1,     ActionParams.ROY_NSPG_2_Low,            0x12,   MarthNSP.ground_main_,          0,                                  0x800D8CCC,                         MarthNSP.kirby_ground_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPG_3_High,            -1,     ActionParams.ROY_NSPG_3_High,           0x12,   MarthNSP.ground_main_,          0,                                  0x800D8CCC,                         MarthNSP.kirby_ground_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPG_3_Mid,             -1,     ActionParams.ROY_NSPG_3_Mid,            0x12,   MarthNSP.ground_main_,          0,                                  0x800D8CCC,                         MarthNSP.kirby_ground_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPG_3_Low,             -1,     ActionParams.ROY_NSPG_3_Low,            0x12,   MarthNSP.ground_main_,          0,                                  0x800D8CCC,                         MarthNSP.kirby_ground_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPA_1,                 -1,     ActionParams.ROY_NSPA_1,                0x12,   MarthNSP.air_main_,             0,                                  0x800D91EC,                         MarthNSP.air_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPA_2_High,            -1,     ActionParams.ROY_NSPA_2_High,           0x12,   MarthNSP.air_main_,             0,                                  0x800D91EC,                         MarthNSP.air_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPA_2_Mid,             -1,     ActionParams.ROY_NSPA_2_Mid,            0x12,   MarthNSP.air_main_,             0,                                  0x800D91EC,                         MarthNSP.air_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPA_2_Low,             -1,     ActionParams.ROY_NSPA_2_Low,            0x12,   MarthNSP.air_main_,             0,                                  0x800D91EC,                         MarthNSP.air_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPA_3_High,            -1,     ActionParams.ROY_NSPA_3_High,           0x12,   MarthNSP.air_main_,             0,                                  0x800D91EC,                         MarthNSP.air_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPA_3_Mid,             -1,     ActionParams.ROY_NSPA_3_Mid,            0x12,   MarthNSP.air_main_,             0,                                  0x800D91EC,                         MarthNSP.air_collision_)
    Character.add_new_action(JKIRBY, ROY_NSPA_3_Low,             -1,     ActionParams.ROY_NSPA_3_Low,            0x12,   MarthNSP.air_main_,             0,                                  0x800D91EC,                         MarthNSP.air_collision_)
    Character.add_new_action(JKIRBY, DRL_NSP_Ground,             0xE7,   ActionParams.DRL_NSP_Ground,            -1,     -1,                             -1,                                 -1,                                 -1)
    Character.add_new_action(JKIRBY, DRL_NSP_Air,                0xE8,   ActionParams.DRL_NSP_Air,               -1,     -1,                             -1,                                 -1,                                 -1)
    Character.add_new_action(JKIRBY, LANKY_NSP_Ground,           0xE7,   ActionParams.LANKY_NSP_Ground,          0x12,   LankyNSP.main_,                 -1,                                 -1,                                 -1)
    Character.add_new_action(JKIRBY, LANKY_NSP_Air,              0xE8,   ActionParams.LANKY_NSP_Air,             0x12,   LankyNSP.main_,                 -1,                                 -1,                                 -1)
    Character.add_new_action(JKIRBY, SSONIC_NSP_Begin,           -1,     ActionParams.SSONIC_NSP_Begin,          0x12,   SonicNSP.ssonic_begin_main_,    0,                              0,                                  0x800DE958)
    Character.add_new_action(JKIRBY, SSONIC_NSP_Move,            -1,     ActionParams.SSONIC_NSP_Move,           0x12,   SonicNSP.ssonic_move_main_,     0,                              SonicNSP.move_physics_,             SonicNSP.ssonic_move_collision_)
    Character.add_new_action(JKIRBY, SSONIC_NSP_Locked_Move,     -1,     ActionParams.SSONIC_NSP_Locked_Move,    0x12,   SonicNSP.ssonic_move_main_,     0,                              SonicNSP.move_physics_,             SonicNSP.ssonic_move_collision_)


    // dark samus b button press buffer setup
    Character.edit_action(JKIRBY,    0xF0,                 -1,             -1,                              DSamusNSP.aerial_b_button_buffer_kirby,                     -1,                             -1)
    ...
    Character.table_patch_start(remix_1p_end_bgm, Character.id.JKIRBY, 0x2)
    dh {MIDI.id.POP_STAR}
    OS.patch_end()

    // Update variants with same model
    Character.table_patch_start(variants_with_same_model, Character.id.JKIRBY, 0x4)
